...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('不動産会社新規登録') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('estate.register') }}">
                        @csrf

                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('不動産会社名') }}</label>
